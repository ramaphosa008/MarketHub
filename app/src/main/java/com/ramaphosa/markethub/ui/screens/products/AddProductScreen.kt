...
import com.ramaphosa.markethub.data.ProductViewModel
        ...
        Column(
            ...
            Surface(
                ...
                AnimatedContent(
                    ...
                    AsyncImage(model = targetUri ?: R.drawable.img_2,
                        contentDescription = "Product Image", contentScale = ContentScale.Crop, modifier = Modifier.fillMaxSize())
                }
            }
            ...
            Row(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(containerColor = green8),
                    shape = RoundedCornerShape(12.dp),
                    modifier = Modifier.width(140.dp)
                ) {
